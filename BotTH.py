...
cl = LineAlpha.LINE()
cl.login(token="Eof4T9jIUsWd9W2i2DE5.hdTmPhwAUT7TvZDoirqFnq.Urkx8HMtfddZEhT9ftngVbKh3q2qcv3XydwHsU7F6og=")
cl.loginResult()
               ...
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            cl.sendText(msg.to,"ไม่มีค้างเชิญครับ")
                        else:
...
#-----------------------------------------------------------
                ...
                #×××××××××××××××××××××××××××××××××××××××××××××××
                    ...
                    cl.sendText(msg.to,"""【•HELP BOT-TH•】

🔰Help v10 {คำสั่งSiri
🔰Help Bot {คำสั่งบอทTH
""")
            elif msg.text in ["Help Bot","คำสั่งบอท"]:
                    cl.sendText(msg.to,"""🔧HELP->BOT-TH🔧

🌟Cancel
🌟เช็ค {ตั้งจับเวลาคนอ่าน
🌟อ่าน{แสดงรายชื่อคนอ่าน
🌟คำสั่ง {แสดงเมนูคำสั่ง
🌟Ginfo{ข้อมูลกลุ่ม
🌟Tagall{คำสั่งแท็กทั้งห้อง
""")
                    ...
                    cl.sendText(msg.to,"Siriv10:招待URL拒否")
